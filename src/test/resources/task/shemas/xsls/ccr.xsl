...
this XSLT back to the community.  
 ...
 -->
<xsl:stylesheet exclude-result-prefixes="a date" version="1.0" xmlns:a="urn:astm-org:CCR"
                ...
                <tr>
                    <th>
                        <font color="#CCCCCC" size="2">
                            The stylesheet used to generate this view of the CCR was provided by the American Academy of
                            Family Physicians and the CCR Acceleration Task Force
                        </font>
                    </th>
                </tr>
                <tr>
